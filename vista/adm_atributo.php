...
<div class="modal fade" id="crearpresentaciones" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidder="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="card card-success">
                <div class="card-header">
                        ...
                        <div class="card-body p-0">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id='presentacion'>
                                    <div class="card card-success">
                                        <div class="card-header">
                                            <div class="card-title">Buscar presentación <button type="button" data-toggle="modal" data-target="#crearpresentaciones" class="btn bg-gradient-primary btn-sm m-2">Crear </button></div>
                                            <div class="input-group">
                                                <input id="buscar-presentaciones" type="text" class="form-control float-left" placeholder="Ingrese nombre">
                                                <div class="input-group-append">
                                                    <button class="btn btn-default"><i class="fas fa-search"></i></button>
                                                </div>
                                            </div>
